...
private:
	bool m_prevSwitchOn;// 直前に全部のスイッチが押されたか
};
...
// 質量ブロッククラス
//*****************************************************************************
class CMassBlock : public CBlock
{
public:
	CMassBlock();
	~CMassBlock();
...
// リスポーンブロッククラス
//*****************************************************************************
class CRespawnBlock : public CBlock
{
public:
	CRespawnBlock();
	~CRespawnBlock();
...
// プレイヤー石像ブロッククラス
//*****************************************************************************
class CPlayerStatueBlock : public CBlock
{
public:
	CPlayerStatueBlock();
	~CPlayerStatueBlock();
