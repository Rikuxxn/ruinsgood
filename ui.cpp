...
void CUi::InitFactory(void)
{
	...
	m_UiFactoryMap[CUi::TYPE_MASK]			= []() -> CUi* { return new CMaskUi(); };
...
// リザルトUI(ランク)の終了処理
//=============================================================================
void CResultRankUi::Uninit(void)
{
	// UIの終了処理
	CUi::Uninit();
}
